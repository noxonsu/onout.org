...
def generate_html_from_markdown(mark, title, PUBLICATION_TAGS, date_iso, author_name, author_link, about_author, CallToActionTitle, CallToActionButton, CallToActionNo,CallToActionLink,meta_description = ''):
    ...
    html = re.sub(r'<a (?!.*?target="_blank")(href="[^"]+")>', r'<a \1 target="_blank" rel="nofollow">', html)
        ...
        <div style='{cta}' class="sticky-panel shadow-2 pa2">
            <div class="layout mw8 center pa0">
                ...
                <div class="w-100 w-100-ns w-100-m w-25-l">
                    <a class="f6 link dim br2 ph3 pv2 dib white bg-dark-blue" href="{CallToActionLink}">{CallToActionButton}</a>
...
def main():
    ...
    CallToActionLink = os.environ.get('CallToActionLink')
